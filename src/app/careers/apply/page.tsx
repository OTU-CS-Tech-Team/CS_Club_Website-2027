...
export default function CareerApplicationPage() {
  ...
  return <div className="careers-page careers-apply-page"><section className="careers-application-panel">
    {submitted ? <div className="careers-success"><h3>Application received.</h3><p>Thanks for putting yourself forward. The CS Club team will be in touch through your Ontario Tech email.</p></div> : <>
      ...
      <form onSubmit={handleSubmit} noValidate><div className="careers-form-grid">
      <label>First name<input name="firstName" aria-required="true" /></label><label>Last name<input name="lastName" aria-required="true" /></label>
      <label className="careers-full-width">Ontario Tech email<input type="email" name="email" placeholder="first.last@ontariotechu.net" pattern="^[^\s@]+@ontariotechu\.net$" title="Use your @ontariotechu.net email address." aria-required="true" /></label>
      ...
      <label className="careers-full-width">Program of study<input name="program" placeholder="e.g. Computer Science" aria-required="true" /></label><label className="careers-full-width">Got ideas for us?<textarea name="ideas" rows={4} placeholder="Tell us what you would love to see from the club..." /></label>
