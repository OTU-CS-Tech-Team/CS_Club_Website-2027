    ...
    {submitted ? <div className="careers-success"><h3>Application received.</h3><p>Thanks for putting yourself forward. The CS Club team will be in touch through your Ontario Tech email.</p></div> : <>
      ...
      <form onSubmit={handleSubmit} noValidate>
        ...
        <div className="careers-form-grid">
          <label>First name<input name="firstName" autoComplete="given-name" aria-required="true" /></label><label>Last name<input name="lastName" autoComplete="family-name" aria-required="true" /></label>
          <label className="careers-full-width">Ontario Tech email<input type="email" name="email" autoComplete="email" placeholder="first.last@ontariotechu.net" pattern="^[^\s@]+@ontariotechu\.net$" title="Use your @ontariotechu.net email address." aria-required="true" /></label>
          <label>Student ID<input name="studentId" inputMode="numeric" placeholder="100123456" pattern="^1\d{8}$" title="Enter your 9-digit student ID beginning with 1." aria-required="true" /></label><label>Year of study<YearSelect /></label>
          <label className="careers-full-width">Program of study<input name="program" placeholder="e.g. Computer Science" aria-required="true" /></label><label className="careers-full-width">Got ideas for us?<textarea name="ideas" rows={4} maxLength={2000} placeholder="Tell us what you would love to see from the club..." /></label>
        </div>
